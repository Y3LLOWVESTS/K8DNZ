...
export K8DNZ_REPLAY_JOBS
export K8DNZ_SURFACE_JOBS
export K8DNZ_BODY_VALIDATE_TOP_K
export K8DNZ_APEX_MAP_SWEEP_JOBS
...
cargo run -p k8dnz-cli --bin apex_law_program -- replay --artifact /tmp/g12_law_program.aklp --out-report /tmp/g12_law_program_replay.txt
...
cargo run -p k8dnz-cli --bin apex_law_program -- replay --artifact /tmp/g1_law_program.aklp --out-report /tmp/g1_law_program_replay.txt
